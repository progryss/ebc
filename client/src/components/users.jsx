...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Button, Modal, IconButton, Typography } from '@mui/material';
...
export default function Users() {
    ...
    return (
        <>
            <Typography variant="h5" sx={{ margin: "20px 0 10px 0" ,paddingLeft: "15px" }}>User Management</Typography>
            <TableContainer>
                    ...
                    <TableBody>
                        {users.map((user, index) => (
                            <TableRow key={`${user.id}-${index}`} sx={{height:'53px'}}>
                                ...
                                <TableCell size='small' >{!user.role ? "User" : "Admin"}</TableCell>
            ...
            <Button variant="contained" onClick={handleOpenAdd} className="mt-5 ms-2">Add New User</Button>
