    ...
    if (userResponse) {
      ...
      try {
        ...
        finalizeToast(
          toastId,
          true,
          `${selectedRows.length} rows deleted Successfully`
        );
      } catch (error) {
  ...
  function updateProgressBar(toastId) {
    const progressInterval = setInterval(async () => {
      ...
      if (!data.totalBatches) {
        // Ensure total is not zero or undefined to avoid division by zero
  ...
  const handleUploadCsv = async () => {
    ...
    try {
      ...
      finalizeToast(
        ...
        false,
        "",
        "Failed to upload CSV ! Required column is missing in CSV (Make, Model, Engine Type, Year). "
      );
      ...
      <div className="container-fluid customer-container">
        <div className="card card-block border-0 customer-table-css-main">
          <div className="card-body p-0">
            <div className="py-2 bg-light add-cutomer-section">
              <div className="row searchParentWrapper">
                ...
                <div className="d-flex">
                  ...
                  <div className="dropdown">
                    ...
                    <ul
                      className="dropdown-menu addCol"
            ...
            <div>
              <Button variant="contained" onClick={handleOpen} className="me-2">
                <AddIcon
                  sx={{ position: "relative", left: "-6px" }}
                  fontSize="small"
                />{" "}
              ...
              <Button variant="contained" onClick={clearAllCaches}>
                <SyncIcon
                  sx={{ position: "relative", left: "-6px" }}
                  fontSize="small"
                />{" "}
            ...
            <div className="table-responsive customerTable mt-2">
                              ...
                              {(provided) => (
                                ...
                                >
                                  <ResizableBox
                                    ...
                                    onResizeStop={(e, data) =>
                                      handleResize(column.id, data.size.width)
                                    }
                                  >
                                    <div
                                      {...(index !== 0 && index !== 1
                                      ...
                                      {column.id === "selectAll" ? (
                                        ...
                                        <div className="d-flex align-items-center gap-2 justify-content-between">
                                          ...
                                          {column.id !== "serialNumber" && (
                                            <div
                                              className="ml-2 sortable-header"
                                              onClick={() =>
            ...
            {/* pagination */}
            {filteredResults.length > 0 && (
              <nav className="mt-2" style={{ position: "relative" }}>
                <div
                  style={{
                    color: "grey",
                    position: "absolute",
                ...
                <ul className="customer-pagination pagination justify-content-center mb-0">
                  <li
                    className={`page-item ${
                  ...
                  >
                    <button
                      ...
                      style={{ borderRadius: "50%", marginRight: "15px",border:'none' }}
                    >
                      ...
                      {pageNumber === "..." ? (
                        ...
                        <button
                          ...
                          style={{
                            ...
                            color: `${
                              pageNumber === currentPage ? "#0d6efd" : "#000"
                            }`,
                            border: "none",
                          }}
                          onClick={() => {
                  ...
                  >
                    <button
                      ...
                      style={{ borderRadius: "50%", marginLeft: "15px",border:'none' }}
                    >
